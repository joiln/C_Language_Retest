...
{	char c='y';
    ...
    Student stu={0};
    while(c=='y'){
        char stu_info[50]={0},ins[50]={0},file[50]="C:\\Users\\sun\\Desktop\\";
        printf("请输入学生所在学院：\n");
        gets(ins);
        strcat(file,ins);
        strcat(file,".txt");
...
{	FILE *fp;
    ...
    char c='y';
    while(c=='y'){
        char newfile[10000]="C:\\Users\\sun\\Desktop\\";//不给10000的话被判断溢出
        char stu_info[50],ins[50],file[50]="C:\\Users\\sun\\Desktop\\";
...
{	FILE *fp;
    ...
    char newfile[10000]="C:\\Users\\sun\\Desktop\\sort_"; //将排好序的学生信息放进新的文件中（文件名已改变！）
    char ins[20],file[50]="C:\\Users\\sun\\Desktop\\";
    printf("请输入学院名称：");
    gets(ins);
    strcat(file,ins);
    strcat(file,".txt");
